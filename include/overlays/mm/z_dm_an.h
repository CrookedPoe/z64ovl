#ifndef __Z64OVL_Z_DM_AN__
#define __Z64OVL_Z_DM_AN__

#define Z_DM_AN_ACTOR_NUMBER     0x029E
#define Z_DM_AN_ACTOR_CATEGORY   ACTORCAT_NPC
#define Z_DM_AN_OBJECT_NUMBER    0x00E2
#define Z_DM_AN_FLAGS            (ACTORFLAG_TALK)

typedef struct z_dm_an_s z_dm_an_t;
struct z_dm_an_s {
    /* 0x0 */ ACTOR actor;
